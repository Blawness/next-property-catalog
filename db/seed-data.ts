import type { properties } from "./schema"

export type PropertyData = Omit<
  typeof properties.$inferInsert,
  "id" | "createdAt" | "status" | "agentId" | "lat" | "lng"
> & { agentId?: string; lat?: string; lng?: string }

export const agents = [
  {
    email: "agent1@example.com",
    passwordHash: "$2a$10$dummy.hash.for.agent1",
...
export const propertyData: PropertyData[] = [
  {
    ...
    description:
      "Rumah minimalis modern dengan 4 kamar tidur, 3 kamar mandi, kolam renang pribadi, dan taman yang indah. Lokasi strategis dekat pusat perbelanjaan dan transportasi umum.",
    price: "2500000000",
    type: "rumah" as const,
  ...
  },
  {
    ...
    description:
      "Apartemen premium dengan pemandangan kota, fasilitas lengkap termasuk gym, kolam renang, dan security 24 jam. Unit 2BR dengan interior modern.",
    price: "1800000000",
  ...
  },
  {
    ...
    description:
      "Tanah kavling seluas 200m² siap bangun dengan sertifikat SHM. Lokasi strategis, dekat tol dan stasiun kereta.",
    price: "800000000",
    type: "tanah" as const,
    listingType: "jual" as const,
    city: "Jakarta",
  ...
  },
  {
    ...
    description:
      "Ruko strategis dengan lokasi prima di jalan utama. Cocok untuk usaha retail atau kantor. Parkir luas dan akses mudah.",
    price: "3500000000",
    type: "ruko" as const,
    listingType: "jual" as const,
    city: "Jakarta",
  ...
  },
  {
    ...
    description:
      "Rumah nyaman 2 lantai dengan 3 kamar tidur. Lokasi tenang namun dekat dengan pusat kota. Furnished lengkap.",
    price: "5000000",
    type: "rumah" as const,
  ...
  },
  {
    ...
    description:
      "Apartemen premium dengan fasilitas hotel bintang 5. 3BR dengan kitchen set lengkap dan balkon luas.",
    price: "1200000000",
    type: "apartemen" as const,
    listingType: "jual" as const,
    city: "Surabaya",
  ...
  },
  {
    ...
    description:
      "Tanah komersial seluas 500m² dengan potensi tinggi untuk pengembangan bisnis. Dekat pelabuhan dan jalan tol.",
    price: "2500000000",
    type: "tanah" as const,
    listingType: "jual" as const,
    city: "Surabaya",
  ...
  },
  {
    ...
    description:
      "Rumah joglo autentik dengan arsitektur Jawa klasik. 4 kamar tidur, taman bunga, dan kolam ikan. Cocok untuk homestay.",
    price: "1500000000",
    type: "rumah" as const,
    listingType: "jual" as const,
    city: "Yogyakarta",
  ...
  },
  {
    ...
    description:
      "Apartemen sederhana namun nyaman untuk mahasiswa atau pekerja. 1BR dengan fasilitas bersama lengkap.",
    price: "1500000",
    type: "apartemen" as const,
    listingType: "sewa" as const,
    city: "Yogyakarta",
  ...
  },
  {
    ...
    description:
      "Ruko 3 lantai dengan desain modern. Cocok untuk kantor atau showroom. Parkir basement dan lift.",
    price: "2800000000",
    type: "ruko" as const,
    listingType: "jual" as const,
    city: "Semarang",
  ...
  },
  {
    ...
    description:
      "Villa mewah dengan pemandangan gunung. 5 kamar tidur, infinity pool, dan taman tropis. Lokasi premium di perbukitan.",
    price: "3200000000",
    type: "rumah" as const,
    listingType: "jual" as const,
    city: "Malang",
  ...
  },
  {
    ...
    description:
      "Tanah seluas 1000m² dengan potensi perkebunan atau villa. Udara sejuk, dekat dengan objek wisata.",
    price: "1500000000",
    type: "tanah" as const,
    listingType: "jual" as const,
    city: "Bogor",
  ...
  },
  {
    ...
    description:
      "Apartemen keluarga dengan 3BR. Fasilitas lengkap termasuk playground dan security. Dekat universitas.",
    price: "900000000",
    type: "apartemen" as const,
    listingType: "jual" as const,
    city: "Depok",
  ...
  },
  {
    ...
    description:
      "Ruko strategis untuk bisnis retail. Lokasi ramai dengan lalu lintas tinggi. Cocok untuk franchise.",
    price: "8000000",
    type: "ruko" as const,
    listingType: "sewa" as const,
    city: "Tangerang",
  ...
  },
  {
    ...
    description:
      "Rumah baru 2 lantai dengan desain minimalis. 3 kamar tidur, garasi 2 mobil. Komplek perumahan elite.",
    price: "1200000000",
    type: "rumah" as const,
    listingType: "jual" as const,
    city: "Bekasi",
...
export const photoIdByProperty: Record<string, string> = {
